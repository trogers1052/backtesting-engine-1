# TEM (Tempus AI) Validated Optimization Results

**Date:** 2026-03-05
**Period:** 2024-06-15 to 2026-02-28
**Initial Cash:** $1,000
**Timeframe:** Daily-only screening + multi-TF re-validation
**Validation Runtime:** 8.7 minutes
**Category:** Tech / Healthcare AI (SPECULATIVE — limited history)
...
TEM — AI genomics/diagnostics — IPO Jun 2024, pre-profit, healthcare AI. Tech / Healthcare AI (SPECULATIVE — limited history).

| Config | Trades | Win Rate | Return | Sharpe | PF | Max DD |
|--------|--------|----------|--------|--------|-----|--------|
| Lean 3 rules baseline (10%/5%, conf=0.50) | 0 | 0.0% | +0.0% | 0.00 | 0.00 | -0.0% |
| Alt A: Full general rules (10 rules, 10%/5%) | 1 | 100.0% | +9.5% | 0.79 | 999.99 | -0.0% |
...
| Alt E: Tech full (13 rules, 10%/5%) | 1 | 100.0% | +9.5% | 0.79 | 999.99 | -0.0% |
...
| BS tune: full rules (10) | 1 | 100.0% | +9.5% | 0.79 |
...
**TEM partially validates.** Best config: Lean 3 rules baseline (10%/5%, conf=0.50) (0/4 gates).
