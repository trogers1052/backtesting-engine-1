# SNDK (Sandisk) Validated Optimization Results

**Date:** 2026-03-05
**Period:** 2024-10-01 to 2026-02-28
**Initial Cash:** $1,000
**Timeframe:** Daily-only screening + multi-TF re-validation
**Validation Runtime:** 15.4 minutes
**Category:** Tech / Semiconductors (SPINOFF — limited history)
...
SNDK — Flash storage/memory — spun from WD Oct 2024, semiconductor adjacent. Tech / Semiconductors (SPINOFF — limited history).
...
| Alt E: Tech full (13 rules, 10%/5%) | 0 | 0.0% | +0.0% | 0.00 | 0.00 | -0.0% |
...
**SNDK partially validates.** Best config: Lean 3 rules baseline (10%/5%, conf=0.50) (0/4 gates).
